...
import { fleamarketStore } from "./fleamarket-store.js";
import { countryStore } from "./country-store.js";
...
export function connectMongo(db: Db) {
  ...
  db.countryStore = countryStore;
  db.fleamarketStore = fleamarketStore;
